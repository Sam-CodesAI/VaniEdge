  ...
  return (
    <section id="industries" className="py-16 sm:py-24 border-b border-slate-800/80 bg-[#070b12] relative">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="rounded-2xl bg-gradient-to-br from-slate-900/90 via-[#0a101b] to-slate-950 border border-slate-800 p-6 sm:p-10 shadow-2xl">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-5">
              ...
              <div className="pt-3 flex flex-wrap items-center gap-4">
                <div className="px-3.5 py-2 rounded-lg bg-emerald-950/40 border border-emerald-500/30 text-emerald-300 text-xs font-mono font-medium">
            ...
            <div className="lg:col-span-5 bg-[#05080e] border border-slate-800 rounded-xl p-5 space-y-3 font-sans shadow-inner">
              <div className="flex items-center justify-between pb-2 border-b border-slate-800 text-[11px] text-slate-400 font-mono">
                ...
                <span>Latency: 11.2ms</span>
              </div>

              <div className="space-y-3 pt-1">
                {/* Caller Message */}
                <div className="flex items-start gap-2 text-xs">
                  <div className="h-6 w-6 rounded-full bg-indigo-500/20 text-indigo-300 flex items-center justify-center font-bold text-[10px] shrink-0 mt-0.5">
                    Caller
                  </div>
                  <div className="p-3 rounded-xl bg-slate-900 border border-slate-800 text-slate-200 leading-relaxed flex-1">
                ...
                <div className="flex items-start gap-2 text-xs">
                  <div className="h-6 w-6 rounded-full bg-emerald-500/20 text-emerald-300 flex items-center justify-center font-bold text-[10px] shrink-0 mt-0.5">
                    Vani
                  </div>
                  <div className="p-3 rounded-xl bg-emerald-950/20 border border-emerald-500/30 text-emerald-100 leading-relaxed flex-1">
